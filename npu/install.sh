...
cp -r "$NPU_SRC/rknn-api/examples/c_demos" "$ROOT/usr/share/rknn-api/examples"
cp -r "$NPU_SRC/rknn-api/doc" "$ROOT/usr/share/rknn-api/doc"
chown -R root:root "$ROOT/usr/share/rknn-api"
